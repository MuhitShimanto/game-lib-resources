  ...
  return (
    <div>
      <div id="cover" className="relative h-[50vh] overflow-hidden">
        ...
        <img src={coverPhoto} alt={title} className="h-full w-full object-cover object-center" />
      </div>
      <div id="info" className="mb-12 max-w-[1600px] mx-auto">
        {/* Tags */}
        <h2 className="mt-3 badge bg-primary text-primary-content">{category}</h2>
        {/* Description */}
        <h1 className="mt-9 text-primary font-bold text-4xl">Description</h1>
        <p className="mt-3 text-white/75 font-normal text-lg">{description}</p>
        {/* Developer */}
